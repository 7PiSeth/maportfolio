...
const NavBar = () => {
  ...
  useEffect(() => {
    const intervalId = setInterval(() => {
      if (
        currentImg ===
        "/maportfolio/static/media/profile.71ab2f04c9052da6949d.png"
      )
        setCurrentImg(cv);
  ...
  return (
    ...
    >
      <div className="absolute top-[7px] left-[calc(50%-41px)]">
        <ToggleTheme />
      </div>
      ...
      <a
        ...
        h-[35px] w-[35px] rounded-[100%] mx-5 p-[2px] bg-slate-300  dark:bg-slate-800 
          ...
          ${
            currentImg ===
            "/maportfolio/static/media/cv.7cfd3e3848953db89f1a.png"
              ? "animate-pulse"
              : ""
          }`}
      >
